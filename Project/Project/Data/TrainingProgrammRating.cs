...
{
    public class TrainingProgrammRating:BDItem
    {
        private int _id;
        ...
        public int TrainingProgrammId { get { return _exerciseId; } set { _exerciseId = value; } }
        ...
        public override List<BDItemParametr> GetParams()
        {
            List<BDItemParametr> list = new List<BDItemParametr>()
            {
                ...
                new BDItemParametr("TrainingProgrammId",ParametrType.INT)
